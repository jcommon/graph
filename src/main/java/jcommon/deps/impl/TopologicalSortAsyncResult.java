...
import jcommon.deps.ITopologicalSortAsyncResult;
...
/**
 * @see jcommon.deps.jdeps.ITopologicalSortAsyncResult
 */
final class TopologicalSortAsyncResult implements ITopologicalSortAsyncResult {
  ...
  /**
   * @see jcommon.deps.jdeps.ITopologicalSortAsyncResult#waitForCompletion()
   */
  @Override
